...
def cargo_command(game_state: Game) -> None:
    ...
    if player_ship.cargohold:
        ...
        game_state.ui.info_message(f"{"Ore":<20} {"Quantity":<10} {"Volume":<10} {"Value/Unit":<12} {"Total Value":<12}")
        ...
        game_state.ui.info_message(f"Total Ore Volume: {player_ship.cargohold_occupied:.2f} m³\n")
    else:
    ...
    if player_ship.mineralhold:
        ...
        game_state.ui.info_message(f"{"Mineral":<20} {"Quality":<10} {"Quantity":<10} {"Volume":<10} {"Value/Unit":<12} {"Total Value":<12}")
        ...
        game_state.ui.info_message(f"Total Mineral Volume: {player_ship.mineralhold_occupied:.2f} m³\n")
    else:
    ...
    game_state.ui.info_message(f"Total Cargo Space Used: {total_occupied:.2f}/{player_ship.cargohold_capacity:.2f} m³")
