...
class Ore:
    ...
    refining_difficulty: float = 1.0  # Higher values mean harder to refine, affects refining time and cost
...
ORES = {
    0: Ore("Pyrogen", 29.0, 0.3, [(0, 0.7), (1, 0.2)], 0, refining_difficulty=1.0),  # Iron, Carbon
    1: Ore("Ascorbon", 16.0, 0.15, [(1, 0.8)], 1, refining_difficulty=1.2),  # Carbon
    2: Ore("Angion", 55.0, 0.35, [(3, 0.6), (4, 0.3)], 2, refining_difficulty=1.5),  # Copper, Zinc
    3: Ore("Varite", 18.0, 0.1, [(10, 0.5)], 3, refining_difficulty=0.8),  # Rare Earth Elements
    4: Ore("Oxynite", 3500.0, 16, [(11, 0.3)], 4, refining_difficulty=2.5),  # Exotic Materials
    5: Ore("Cyclon", 600.0, 2, [(2, 0.7), (5, 0.2)], 5, refining_difficulty=1.8),  # Silicon, Aluminum
    6: Ore("Heron", 1200.0, 3, [(6, 0.5), (7, 0.4)], 6, refining_difficulty=2.0),  # Titanium, Nickel
    7: Ore("Jonnite", 7250.0, 16, [(9, 0.2), (10, 0.1)], 7, refining_difficulty=3.0),  # Gold, Rare Earth Elements
    8: Ore("Magneton", 580.0, 1.2, [(0, 0.4), (8, 0.5)], 8, refining_difficulty=2.2),  # Iron, Neodymium
}
