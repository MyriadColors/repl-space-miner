...
def integrate_dual_fuel_system():
    ...
    setattr(Ship, 'emergency_antimatter_ejection', DualFuelSystem.emergency_antimatter_ejection)
    ...
    def extended_init(self, *args, **kwargs):
        ...
        self.location = getattr(self, "space_object", IsSpaceObject(Vector2(0, 0), 0)).position
